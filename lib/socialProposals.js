...
// JSON strutturato con 3 proposte di post.
...
function safeParseJsonArray(text) {
  ...
  // Quando si usa il grounding con la ricerca web, Gemini a volte aggiunge
  // testo o citazioni prima/dopo il JSON richiesto: isoliamo solo la parte
  // tra la prima "[" e l'ultima "]" prima di provare il parsing.
